...
bool PlayerbotAIConfig::Initialize()
{
	...
	shootDistance = sConfigMgr->GetFloatDefault("AiPlayerbot.ShootDistance", 20.0f);
	...
	ClassicBotMode = sConfigMgr->GetBoolDefault("Classic.Playerbots.Mode", false);
    randomBotAutologin = sConfigMgr->GetBoolDefault("AiPlayerbot.RandomBotAutologin", true);
	lootRestrictions = sConfigMgr->GetBoolDefault("AiPlayerbot.LootRestrictions", false);
    ...
    randomBotTeleportDistance = sConfigMgr->GetIntDefault("AiPlayerbot.RandomBotTeleportDistance", 133);
	...
	InvLevel = sConfigMgr->GetFloatDefault("AiPlayerbot.InvLevel", 5);
	...
	nonCombatStrategies = sConfigMgr->GetStringDefault("AiPlayerbot.NonCombatStrategies", "+custom::say,+loot");
	combatStrategies = sConfigMgr->GetStringDefault("AiPlayerbot.CombatStrategies", "+custom::say");
	nonCombatStrategies = sConfigMgr->GetStringDefault("AiPlayerbot.NonCombatStrategies", "+custom::say");
